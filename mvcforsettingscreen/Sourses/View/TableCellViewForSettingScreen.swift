//
//  TableCellViewForSettingScreen.swift
//  mvcforsettingscreen
//
...
class OnboardingTableCellonViewForSettingScreen: UITableViewCell {
    
    static let identifier = "OnboardingTableCellonViewForSettingScreen"
    ...
    private func setupLayout() {
        NSLayoutConstraint.activate([
            ...
            additionalInfo.trailingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 250),
